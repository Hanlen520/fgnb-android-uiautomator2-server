...
public class UIAutomatorWDServer extends RouterNanoHTTPD {
    ...
    private UIAutomatorWDServer(int port) throws IOException {
        ...
        //toastRouter add 20180716
        addRoute(sessionRoutePrefix + "/getToast",Methods.GET,ToastController.toast);
        //ping add 20180731
        addRoute(sessionRoutePrefix + "/ping",Methods.GET,PingController.ping);

        start(NanoHTTPD.SOCKET_READ_TIMEOUT, false);
        System.out.println("\nRunning! Point your browsers to http://localhost:8080/ \n");

        //支持toast add 20180716
        InstrumentationRegistry.getInstrumentation().getUiAutomation().setOnAccessibilityEventListener(new AccessibilityEventListener());
